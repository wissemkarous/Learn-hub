...
public class HotelReviewApp extends JFrame {
    ...
    public HotelReviewApp() {
        criteriaScores = new LinkedHashMap<>(); // Utilisation de LinkedHashMap pour maintenir l'ordre des critères
    ...
    private void saveDataToCSV(String hotelName) {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(fileName, true))) {
            if (!fileExists) {
                // Écrire les noms des colonnes s'il s'agit d'un nouveau fichier
